...
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form"%>
	...
	<div class="container">
		...
		<div class="form-group text-center">
			<a href="aceptar.do" class="btn btn-success"> 
				<span class="glyphicon glyphicon-ok" aria-hidden="true"></span> <fmt:message key="boton.aceptar"/> 
			</a>					
			<a href="rechazar.do" class="btn btn-danger">
				<span class="glyphicon glyphicon-remove" aria-hidden="true"></span> <fmt:message key="boton.rechazar"/>
			</a>
		</div>
